...
def main():
    ...
    # time.
    if os.path.exists(EnvManager.token_path):
        creds = Credentials.from_authorized_user_file(EnvManager.token_path, SCOPES)
    ...
    if not creds or not creds.valid:
        ...
        with open(EnvManager.token_path, 'w') as token:
